...
```
Para modificar el idioma vamos a la extención e instalamos y reiniciamos VSC Y viceversa para restaurar el idioma.
...
```
Nos abre la web y debemos registrarnos ya sea con hitgub o google o como deseemos
```
